...
class GameBoard:
    ...
    def __init__(self, title, game, size, bkColor='SteelBlue', buttonColor='LightSalmon'):
        ...
        self.up = Button(Point(buttonX + buttonWidth*5/8, buttonY),
                         "^", partial(self.do, self.game.go_up), buttonColor)
        self.up.draw(self.window)
        self.down = Button(Point(buttonX + buttonWidth*5/8, buttonY + lineSpace*2),
                           "V", partial(self.do, self.game.go_down), buttonColor)
        self.down.draw(self.window)
        self.left = Button(Point(buttonX + buttonWidth*4/8, buttonY + lineSpace),
                           "<--", partial(self.do, self.game.go_left), buttonColor)
        self.left.draw(self.window)
        self.right = Button(Point(buttonX + buttonWidth*6/8, buttonY + lineSpace),
        ...
        self.open_wormhole = Button(Point(buttonX + buttonWidth*1/5, buttonY + lineSpace*2.3),
                                    "Open Wormhole",
                                    partial(self.do, self.game.open_wormhole), buttonColor)
        self.open_wormhole.draw(self.window)
