...
int main()
{
    ...
    // The difference between consecutive floats are not the same
    // The difference is greater for bigger numbers.
    // If we add 1 to the greatest possible float number, we get infinity, and after that, NaN.
    return 0;
}
